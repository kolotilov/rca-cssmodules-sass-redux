Pretty common boilerplate for kickstarting front-end apps. It is upon React Create App, which was ejected and extended with support of CSS modules, SASS and Redux.



React Create App readme with tons of useful info goes below:
